...
Q_CONSTINIT const QMetaObject SinGenerator::staticMetaObject = { {
    QMetaObject::SuperData::link<ComponentInterface::staticMetaObject>(),
...
void *SinGenerator::qt_metacast(const char *_clname)
{
    ...
    return ComponentInterface::qt_metacast(_clname);
}

int SinGenerator::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ComponentInterface::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)

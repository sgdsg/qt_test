...
template <> constexpr inline auto ClientSession::qt_create_metaobjectdata<qt_meta_tag_ZN13ClientSessionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleSinData'
        QtMocHelpers::SlotData<void(QVector<int16_t>)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'handleFFTData'
        QtMocHelpers::SlotData<void(QVector<float>)>(8, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 9, 7 },
        }}),
    };
...
void ClientSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->handleSinData((*reinterpret_cast<std::add_pointer_t<QList<int16_t>>>(_a[1]))); break;
        case 3: _t->handleFFTData((*reinterpret_cast<std::add_pointer_t<QList<float>>>(_a[1]))); break;
        default: ;
        }
    }
